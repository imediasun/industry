...
<div class="boxed">
    ...
    <section id="content-container">
            <header class="pageheader">
                <h3><i class="fa fa-home"></i> Станок Фрезерный Hitachi </h3>
                ...
                <div class="breadcrumb-wrapper"> <span class="label">You are here:</span>
                    <ol class="breadcrumb">
                        <li> <a href="#"> Home </a> </li>
                        <li class="active"> Станок Фрезерный Hitachi </li>
                    </ol>
                </div>
            </header>
    </section>        
                            ...
                            <div class="panel-body">
                                ...
                                <div id="example3" class="slider-pro">
                                    <div style="min-height:400px;" class="sp-slides">
                                        <div class="sp-slide">
                                            <img class="sp-image" src="../src/css/images/blank.gif"
                                                 data-src="/img/image1_medium.jpg"
                                                 data-small="/img/image1_small.jpg"
                                                 data-medium="/img/image1_medium.jpg"
                                                 data-large="/img/image1_large.jpg"
                                        ...
                                        <div class="sp-slide">
                                            <img class="sp-image" src="../src/css/images/blank.gif"
                                                 data-src="/img/image2_medium.jpg"
                                                 data-small="/img/image2_small.jpg"
                                                 data-medium="/img/image2_medium.jpg"
                                                 data-large="/img/image2_large.jpg"
                                    ...
                                    <div style="margin-top:130px" class="sp-thumbnails">
                                        <img class="sp-thumbnail" src="/img/image1_thumbnail.jpg"/>
                                        <img class="sp-thumbnail" src="/img/image2_thumbnail.jpg"/>
                                        <img class="sp-thumbnail" src="/img/image1_thumbnail.jpg"/>
                                        <img class="sp-thumbnail" src="/img/image2_thumbnail.jpg"/>
                                        <img class="sp-thumbnail" src="/img/image1_thumbnail.jpg"/>
                                        <img class="sp-thumbnail" src="/img/image2_thumbnail.jpg"/>
