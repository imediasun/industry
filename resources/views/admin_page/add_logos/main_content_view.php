                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal form-bordered" method="post" action="/functions_form" id="wizard-validate">
                                ...
                                <div class="wizard-title"> Логотип партнера </div>
                                <div class="wizard-container">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <h5 class="semibold text-primary">
                                                <i class="fa fa-cog"></i> Логотип партнера
                                            </h5>
                                            <p class="text-muted"> Додайте логотип партнера </p>
                                        </div>
                                    </div>
                                    <div class="form-group">
