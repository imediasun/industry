                    ...
                    <ul id="mainnav-menu_2" class="list-group">
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li><a href="ui-button.html"><i class="fa fa-caret-right"></i> Button </a></li>
                                <li><a href="ui-checkboxes-radio.html"><i class="fa fa-caret-right"></i> Checkbox & Radio </a></li>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li><a href="pages-gallery.html"><i class="fa fa-caret-right"></i> Gallery <span class="label label-info pull-right">New</span></a></li>
